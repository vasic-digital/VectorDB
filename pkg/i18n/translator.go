...
// VectorDB submodule. It is the CONST-046-compliant indirection between
...
// default), and the VectorDB submodule never reaches into a parent project
// to discover its own catalogue.
//
// Usage:
//
//	t := i18n.NoopTranslator{} // production default — returns key verbatim
//	msg := t.T("vectordb_validation_vector_values_empty", nil)
//
// Consuming projects wire a real translator that loads
// bundles/active.en.yaml + locale overrides; the VectorDB submodule
...
// validation surface shape ("vectordb_validation_vector_values_empty")
