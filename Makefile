# VectorDB - Generic, reusable Go module for vector database operations. Provides a unified interface across multiple vector database backends.
...
challenge:
	../challenges/scripts/vectordb_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "VectorDB - Generic, reusable Go module for vector database operations. Provides a unified interface across multiple vector database backends."
	@echo ""
	@echo "Build & Test:"
